    ...
    return (
        <div className='max-w-7xl mx-auto px-5 flex flex-col justify-between items-center sm:flex-row gap-8'>
            ...
            <div className='w-full sm:w-1/2 flex flex-col gap-6 sm:order-1'>
                ...
                <div className='w-fit bg-white flex items-center justify-center px-8 py-4 rounded-full text-grad button_text relative border-2 border-[#FF8B13] cursor-pointer'>About Us</div>
            </div>
        </div>
    )
}
