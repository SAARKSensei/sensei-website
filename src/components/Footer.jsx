...
const Footer = () => {
  ...
  return (
    <div>
      <div className="flex-col sm:flex-row  flex-wrap sm:flex-nowrap rounded-[calc(4vw)] md:rounded-b-none bg-grad_1 gap-4 sm:gap-10 lg:gap-20 justify-center p-4 flex md:text-base text-xs font-normal text-slate-200">
      ...
      <div className="bg-gradient-to-t from-[#2C3D68] to-[#0764A7]">
        <div
          ...
          className="relative w-max-full  rrounded-bl-none rrounded-[calc(4vw)] md:rrounded-t-none p-6 md:p-10 min-[1300px]:p-20 "
        >
